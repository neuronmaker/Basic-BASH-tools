...
#To find this, run gpg -K command, this will print the keys which you have the private key for, then copy the last 16 digits of your preferred key fingerprint. Refer to the guide that Github published on how to enable git signing.
gpgKey="48A73B8C89207930" #this is my current preferred key, you should use your own
#uncomment below to unset previous a configuration
#git config --global --unset gpg.format
#tell git about our GnuPG key
git config --global user.signingkey $gpgKey

#setting default git options
signCommits="true" #"true" signs commits by default, "false" requires use of the -S option
signTags="true" #"true signs by default, "false" does not
#apply these options
